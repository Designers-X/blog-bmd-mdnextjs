...
const Amrit = () => {
  return (
    <Layout>
      <h1>Welcome to amrit test page.</h1>
      <p>
        ...
        publishing packages and web page editors now use Lorem Ipsum as their default model text&lsquo; and a search for
      ...
      <p>
        ...
        some form, by injected humour&lsquo; or randomised words which don&apos;t look even slightly believable. If you
        are going to use a passage of Lorem Ipsum&lsquo; you need to be sure there isn&apos;t anything embarrassing
